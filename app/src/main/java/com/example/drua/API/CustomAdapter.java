...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    private ArrayList<com.example.drua.API.Product> arrayList;  // 유저정보를 담음.
    private Context context;
    Product pdt = new Product();

    public CustomAdapter(ArrayList<com.example.drua.API.Product> arrayList, Context context) {
