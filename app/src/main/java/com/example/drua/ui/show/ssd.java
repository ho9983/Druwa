...
import com.example.drua.API.SSD_Search_API;
...
public class ssd extends AppCompatActivity {
    private Button butt_move_ssd;
    private TextView tv_result_ssd;
    private TextView tv_price_ssd;
    ...
    private Spinner spin_ssd;
    private Spinner spin_price_ssd;

    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ssd);

        tv_result_ssd=findViewById(R.id.tv_result_ssd);
        tv_price_ssd=findViewById(R.id.tv_price_ssd);
        spin_ssd=findViewById(R.id.spin_ssd);
        spin_price_ssd=findViewById(R.id.spin_price_ssd);

        spin_ssd.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_result_ssd.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        spin_price_ssd.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_price_ssd.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        butt_move_ssd = findViewById(R.id.butt_move_ssd);
        butt_move_ssd.setOnClickListener(new View.OnClickListener() {   //글카 검색
            @Override
            public void onClick(View v) {
                ...
                String json = null;
                try {
                    json = new SSD_Search_API().execute().get();
                ...
                String nameText = tv_result_ssd.getText().toString();
                String priceText = tv_price_ssd.getText().toString();
