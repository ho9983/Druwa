...
import com.example.drua.API.Path;
...
public class cpu extends AppCompatActivity {
    private Button butt_move_cpu;
    private String pathtext;
    private Spinner spin_cpu;
    private Spinner spin_price_cpu;
    private TextView tv_result_cpu;
    private TextView tv_price_cpu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_result_cpu = findViewById(R.id.tv_result_cpu);
        tv_price_cpu = findViewById(R.id.tv_price_cpu);
        spin_cpu = findViewById(R.id.spin_cpu);
        spin_price_cpu = findViewById(R.id.spin_price_cpu);

        spin_cpu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_result_cpu.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        spin_price_cpu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_price_cpu.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        butt_move_cpu = findViewById(R.id.butt_move_cpu);
        butt_move_cpu.setOnClickListener(new View.OnClickListener() {   //cpu 버튼
            @Override
            public void onClick(View v) {
                ...
                try {
                    json = new CPU_Search_API().execute().get();
                ...
                String nameText = tv_result_cpu.getText().toString();
                String priceText = tv_price_cpu.getText().toString();
