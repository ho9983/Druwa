...
import com.example.drua.API.Case_Search_API;
...
public class pc_case extends AppCompatActivity {
    private Button butt_move_pc_case;
    private TextView tv_result_case;
    private TextView tv_price_case;
    ...
    private Spinner spin_price_case;



    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pc_case);

        tv_result_case=findViewById(R.id.tv_result_case);
        tv_price_case=findViewById(R.id.tv_price_case);
        spin_case=findViewById(R.id.spin_case);
        spin_price_case=findViewById(R.id.spin_price_case);

        spin_case.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_result_case.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        spin_price_case.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_price_case.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        butt_move_pc_case = findViewById(R.id.butt_move_pc_case);
        butt_move_pc_case.setOnClickListener(new View.OnClickListener() {   //글카 검색
            @Override
            public void onClick(View v) {
                ...
                String json = null;
                try {
                    json = new Case_Search_API().execute().get();
                ...
                String nameText = tv_result_case.getText().toString();
                String priceText = tv_price_case.getText().toString();
