...
public class graphic_card extends AppCompatActivity {
    private Button butt_move_gpu;
    private TextView tv_result_gpu;
    private TextView tv_price_gpu;
    ...
    private Spinner spin_gpu;
    private Spinner spin_price_gpu;


    //확인
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.graphic_card);

        tv_result_gpu=findViewById(R.id.tv_result_gpu);
        tv_price_gpu=findViewById(R.id.tv_price_gpu);
        spin_gpu=findViewById(R.id.spin_gpu);
        spin_price_gpu=findViewById(R.id.spin_price_gpu);



        spin_gpu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {   // 브랜드 선택
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_result_gpu.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        spin_price_gpu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {     //가격 선택
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tv_price_gpu.setText(parent.getItemAtPosition(position).toString());
            }
        ...
        butt_move_gpu = findViewById(R.id.butt_move_gpu);
        butt_move_gpu.setOnClickListener(new View.OnClickListener() {   //글카 검색
            @Override
            public void onClick(View v) {
                ...
                String json = null;
                try {
                    json = new GPU_Search_API().execute().get();
                ...
                String nameText = tv_result_gpu.getText().toString();
                String priceText = tv_price_gpu.getText().toString();
